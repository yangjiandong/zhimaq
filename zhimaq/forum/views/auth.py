...
def signin_page(request):
    ...
    # just keep google openid
    bigicon_providers = sorted([
    context for context in all_providers if context.id == "google" and context.mode == 'BIGICON' and can_show(context)
    ], sort)
        ...
        try:
            ...
            try:
                ...
                if email:
                    ...
                    if user_:
                        assoc = AuthKeyUserAssociation.objects.get(user=user_.id)
