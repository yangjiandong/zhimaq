...
(= this-site*    "芝麻新闻"
   site-url*     "http://news.zhimaq.com/"
   parent-url*   "http://www.zhimaq.com"
   favicon-url*  "http://www.zhimaq.com/upfiles/favicon.ico"
   site-desc*    "芝麻IT业界新闻动态"               ; for rss feed
   site-color*   (color 180 180 180)
   border-color* (color 180 180 180)
   footer*       "<a title='意见、建议反馈' href='http://www.zhimaq.com/pages/feedback/'>意见反馈</a>
        | <a title='芝麻问答' href='http://www.zhimaq.com/'>芝麻问答</a>
        | <a title='推荐到芝麻功能书签' href='http://www.zhimaq.com/bookmarklet/'>芝麻书签</a>        
        | <a href='http://www.zhimaq.com/contact/'>联系我们</a>   
        | <a href='http://www.zhimaq.com/about/'>关于本站</a>
        | <a href='http://www.zhimaq.com/faq/'>网站FAQ</a>
        | <a href='http://www.zhimaq.com/privacy/'>隐私政策</a>
        | <a title='芝麻源代码' href='http://bitbucket.org/felinx/zhimaq' target='_blank'>网站代码</a>
        <script type='text/javascript' src='http://v1.jiathis.com/code/jia.js?uid=1500189' charset='utf-8'></script>
        "
   jiathis*  "<a href='http://www.jiathis.com/share/?uid=1500189' class='jiathis' target='_blank'><img src='http://v1.jiathis.com/code/images/jiathis2.gif' border='0' /></a>"
   prefer-url*   t)
...
(def gen-css-url ()
  ...
  (prn "<link rel=\"alternate\" type=\"application/rss+xml\" title=\"RSS\" href=\"/rss\">")  
)
...
(defop news.css req
  (pr "
body  { font-family: Arial,Helvetica,sans-serif; font-size:10pt; color:#828282; }
td    { font-family: Arial,Helvetica,sans-serif; font-size:10pt; color:#828282; }

.admin td   { font-family: Arial,Helvetica,sans-serif; font-size:8.5pt; color:#000000; }
.subtext td { font-family: Arial,Helvetica,sans-serif; font-size:  7pt; color:#828282; }
...
.default { font-family: Arial,Helvetica,sans-serif; font-size: 10pt; color:#828282; }
.admin   { font-family: Arial,Helvetica,sans-serif; font-size:8.5pt; color:#000000; }
.title   { font-family: Arial,Helvetica,sans-serif; font-size: 10pt; color:#828282; }
.adtitle { font-family: Arial,Helvetica,sans-serif; font-size:  9pt; color:#828282; }
.subtext { font-family: Arial,Helvetica,sans-serif; font-size:  7pt; color:#828282; }
.yclinks { font-family: Arial,Helvetica,sans-serif; font-size:  8pt; color:#828282; }
.pagetop { font-family: Arial,Helvetica,sans-serif; font-size: 10pt; color:#222222; }
.comhead { font-family: Arial,Helvetica,sans-serif; font-size:  8pt; color:#828282; }
.comment { font-family: Arial,Helvetica,sans-serif; font-size:  9pt; }
.dead    { font-family: Arial,Helvetica,sans-serif; font-size:  9pt; color:#dddddd; }
...
.jiathis {margin-left:20px;}
.jiathis img {margin-bottom:-6px;}
...
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-9694421-9']);
_gaq.push(['_setDomainName', '.zhimaq.com']);
...
(def gen-logo ()
  (tag (td style "width:18px;padding-right:4px")
    (tag (a href parent-url*)
      (tag (img src logo-url* width 16 height 16 
...
(def toprow (user label)
  (w/bars
    ...
    (prn "<a href='http://www.zhimaq.com/pages/ask/' title='Ask a question'>ask</a>")
